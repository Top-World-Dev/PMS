<template>
  <b-navbar fixed="top" toggleable="lg" type="dark" variant="info">
    <b-navbar-brand to="/">PMS Dashboard</b-navbar-brand>
    ...
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav>
        ...
        <b-nav-item to="/patients">{{ $t('navigation.patients.index') }}</b-nav-item>
        <b-nav-item to="/doctors">{{ $t('navigation.doctors.index') }}</b-nav-item>
        <b-nav-item to="/dashboard/chambers">{{ $t('navigation.chambers.index') }}</b-nav-item>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item to="/">{{ $t('navigation.index') }}</b-nav-item>
